module nsga2_module
	...
	public :: crossover, mutation, mutation_ad_1, mutation_ad_2, evaluate_peak_rsd, &
	& pareto, evaluate_peak_rsd_y, check_k, crowd_dist, delete_z_i
...
!	integer	::	new_asg_2n(n_table, 2), new_idx_2n(n_table, 2), old_asg_2n(n_table, 2)
	...
	& N_seq, n_table, note_rstr, group_new, pareto_order, dist_group)
	!
	use qsort_c_module
	implicit none
	!
