...
class FileIOTest(unittest.TestCase):
    ...
    Use nearly ideal GB1 data to test reading and writing files for GA assign.
    """
    def setUp(self):
    ...
    def test_sequence_round_trip(self):
        ...
        with open(os.path.join(self.test_dir, 'test_seq.fasta'), 'w') as fid:
            fileio.write_sequence(sequence, fid)

        with open(os.path.join(self.test_dir, 'test_seq.fasta'), 'r') as fid:
    ...
    def test_groups_assignments_round_trip(self):
        ...
        self.assertEqual(groups[10].assignments, new_groups[10].assignments)
